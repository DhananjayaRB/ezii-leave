...
export function usePermissions() {
  ...
  const [permissions, setPermissions] = useState<PermissionStructure | null>(
    permissionsCache,
  );
          ...
          try {
            ...
            if (response.ok) {
              ...
              if (userRole && userRole.permissions) {
                console.log(
                  "Using database role permissions for",
                  role,
                  ":",
                ...
                console.log(
                  ...
                  userRole.permissions.workflows,
                );
                ...
                if (
                  ...
                  Object.keys(userRole.permissions).length === 0
                ) {
            ...
            console.error(
              "Error fetching role permissions from database:",
              error,
            );
          }
        }
  ...
  const hasPermission = (
    screen: keyof PermissionStructure,
