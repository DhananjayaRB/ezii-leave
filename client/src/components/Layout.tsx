...
export default function Layout({ children }: LayoutProps) {
  ...
  const allNavigationItems = [
    ...
    // Employee Navigation
    { name: "Employee Overview", href: "/employee-overview", icon: Home, permission: "employeeOverview", type: "employee" },
    { name: "Leave Applications", href: "/applications", icon: Home, permission: "leaveApplications", type: "employee" },
    { name: "Holidays", href: "/holidays", icon: Home, permission: "holidays", type: "employee" },
    { name: "Compensatory Off", href: "/compensatory-off", icon: Home, permission: "compensatoryOff", type: "employee" },
    { name: "PTO", href: "/pto", icon: Home, permission: "pto", type: "employee" },
  ...
  const allConfigurationItems = [
    ...
    { name: "Feature Settings", href: "/admin/feature-settings", icon: Settings, permission: "adminSettings" },
  ];
  ...
  const allEmployeeReportItems = [
    { name: "My Dashboard", href: "/reports/dashboard", icon: FileText, permission: "employeeReports" },
